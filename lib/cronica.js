var fs = require('fs')
  ...
  , config = require(process.env.PWD + '/cronica.json');


var cronica = {};
module.exports.cronica = cronica;
...
cronica.commit = function(file, cb){
  var msg = "[Content Revision] File was updated.";
  execute( 'git commit -m "' + msg + '" ' + file, function(stdout,stderr){
...
cronica.revert = function(file, cb){
